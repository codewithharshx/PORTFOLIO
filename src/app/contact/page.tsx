...
const socialBentoData: SocialBentoItem[] = [
  {
    id: 'github',
    name: 'GitHub',
    handle: '@codewithharshx',
    url: 'https://github.com/codewithharshx',
    icon: Github,
  ...
  },
  {
    id: 'linkedin',
    name: 'LinkedIn',
    handle: 'Harshwardhan Sathe',
    url: 'https://www.linkedin.com/in/harshwardhan-sathe-774945332/',
    icon: Linkedin,
  ...
  },
  {
    ...
    name: 'Instagram',
    handle: '@harsh_r_s_11',
    url: 'https://www.instagram.com/harsh_r_s_11',
    icon: Instagram,
  ...
  },
  {
    id: 'email',
    name: 'Email',
    handle: 'harshwardhansathe1@gmail.com',
    url: 'mailto:harshwardhansathe1@gmail.com',
    icon: Mail,
  ...
  },
  {
    id: 'phone',
    name: 'Phone',
    handle: '+91 8879970396',
    url: 'tel:+918879970396',
    icon: Phone,
            ...
            >
              ...
              <div className="flex justify-between items-center border-b border-neutral-100 pb-2.5 z-10 mt-1">
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] font-extrabold tracking-[0.15em] text-neutral-800 font-jakarta">H</span>
                  <span className="text-[9px] font-bold tracking-[0.1em] text-neutral-500 font-jakarta">SATHE</span>
                </div>
